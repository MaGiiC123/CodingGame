...
{
    //func => function with return value, func<t1, t2> => ( t1 = return type, <t2> => parameter)
    //action => function without return value, action<t> => t = parameters
    ...
    public List<VirtualFunction> Run()
    {
        ...
        ExecuteParsedFunctions();
        return outputs;
    }

    void ExecuteParsedFunctions()
    {
    ...
    public void PlayerCodeCallableFunction()
    {
        Debug.Log("workss!");
    }
