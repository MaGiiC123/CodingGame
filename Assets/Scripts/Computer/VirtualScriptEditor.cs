...
public class VirtualScriptEditor : VirtualProgram
{
    ...
    string legalChars = "abcdefghijklmnopqrstuvwxyz 0123456789+-/*=<>()[]{}.:_,;";
    ...
    void HandleTextInput()
    {
        ...
        if (!Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.AltGr)) //&& !Input.GetKey(KeyCode.LeftControl)) TODO: differentiate between alt and command key
        {
